/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: cddcfe88e61adfb0aa27fd5d4a3f739a)
...
interface __BaseEnv_CloudflareEnv {
	...
	SUPER_COACH_DATA_SECRET: string;
	HEALTH_WEBHOOK_SECRET: string;
	SUPER_COACH_DEV_LOOPBACK_BYPASS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONVEX_DEPLOYMENT" | "NEXT_PUBLIC_CONVEX_URL" | "NEXT_PUBLIC_CONVEX_SITE_URL" | "SUPER_COACH_DATA_SECRET" | "HEALTH_WEBHOOK_SECRET" | "SUPER_COACH_DEV_LOOPBACK_BYPASS">> {}
}
